...
export default function Home() {
  ...
  const groups = groupsForRole(user?.role || 'employee', { comiteHys: !!user?.comiteHys, comiteAcceso: user?.acceso, modulosOcultos: user?.modulosOcultos }).filter((g) => g.items.some((it) => it.ready));
