...
/* eslint-disable */
export interface Emp { nom: string; leg?: string; legNum?: string; emp?: string; empresa?: string; lugar?: string; cat?: string; tramo?: string; tarea?: string; desc_categoria?: string; foto?: string; validador?: string; areaOrg?: string; area?: string; validadorGoToHR?: boolean; validadorAutoApproved?: boolean; }
